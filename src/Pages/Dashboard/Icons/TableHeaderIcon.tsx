...
const TableHeaderIcon = ({ onClick, children }:Props) => {
  return (
    <span ><svg onClick={onClick} className= {styles.icon} width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
